...
with DAG(
    ...
    silver_task = SparkSubmitOperator(
        ...
        application="/usr/local/airflow/include/spark_code/task_silver_clean.py",
    ...
    gold_task = SparkSubmitOperator(
        ...
        application="/usr/local/airflow/include/spark_code/task_build_features_gold.py",
        conn_id="spark_default",
        jars=jars
    )
    ...
    clustering_task = SparkSubmitOperator(
        ...
        application="/usr/local/airflow/include/spark_code/task_data_clustering.py",
        conn_id="spark_default",
        jars=jars
    )

    silver_task >> gold_task >> clustering_task
    # gold_task >> clustering_task
    # clustering_task
