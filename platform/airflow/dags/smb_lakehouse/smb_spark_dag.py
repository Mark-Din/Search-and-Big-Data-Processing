...
with DAG(
    ...
    silver_task = SparkSubmitOperator(
        ...
        application="/opt/airflow/include/spark_code/silver_clean.py",
    ...
    gold_task = SparkSubmitOperator(
        ...
        application="/opt/airflow/include/spark_code/build_features_gold.py",
        conn_id="spark_default",
        jars=jars
    )
    ...
    clustering_task = SparkSubmitOperator(
        ...
        application="/opt/airflow/include/spark_code/data_clustering.py",
        conn_id="spark_default",
        jars=jars
    )
